...
смысловой (смысл и критерии — `meaning-protocol.md`). Линзы качества языка
тянутся из `language-failure-modes.md`.
...
Протокол — `placement-protocol.md`; findings и выход — `placement-findings.md`.
