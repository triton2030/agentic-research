---
description: "Claude Code: description limits, placement rules, проверка загрузки."
read-when: "Спорны размер skill description, выбор surface для правила или проверка load moment."
---

# Claude Code Discovery — Limits, Placement, Проверка

Что грузится когда — `discovery-loading.md`.
