...
Root/subtree topology → `placement-scope.md`; load-bearing meaning и
criteria → `meaning-protocol.md`; named model-specific tell →
`divergences-contract.md`.
...
Порядок суждения и контракт находок — `language-judgment.md`.
