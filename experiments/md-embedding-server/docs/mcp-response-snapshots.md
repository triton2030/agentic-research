...
Generated 2026-06-11 from live CLI. Count: 34.

| Tool | File | is_error |
|---|---|---|
| md_audit | tests/golden/mcp-responses/md_audit.json | true |
| md_canon_check | tests/golden/mcp-responses/md_canon_check.json | false |
...
| md_corpus_scan | tests/golden/mcp-responses/md_corpus_scan.json | false |
| md_cycles | tests/golden/mcp-responses/md_cycles.json | false |
| md_deps | tests/golden/mcp-responses/md_deps.json | false |
| md_edit_context | tests/golden/mcp-responses/md_edit_context.json | false |
| md_extract | tests/golden/mcp-responses/md_extract.json | false |
...
| md_semantic_neighbors | tests/golden/mcp-responses/md_semantic_neighbors.json | true |
