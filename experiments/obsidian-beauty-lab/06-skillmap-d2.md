...
> [!example]+ Смысл
> `1start-here` сначала восстанавливает реальную просьбу и выбирает маршрут.
> Дальше работа расходится в стратегию, правку, системные правила,
> пользовательскую правду или проверку.
>
