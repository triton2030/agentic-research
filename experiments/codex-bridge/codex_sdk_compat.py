...
ChatGPT.app авто-обновляет движок, а requirements.txt пинит SDK (0.157.1), так
...
`0.147.0` (+`PlanType`), те же 3 из 122 в `0.154.0` и из 127 в `0.157.1` (пин с 2026-09-26). Живой
дрейф на 2026-09-01: движок `0.151.0-alpha.7.2` шлёт
`SubAgentActivityKind='completed'`, которого не знала ни одна из версий до
`0.154.0`. Пока `openai/codex#21871` открыт, класс-за-классом остаётся правилом.
