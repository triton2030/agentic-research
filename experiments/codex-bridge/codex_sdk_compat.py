...
ChatGPT.app авто-обновляет движок, а requirements.txt пинит SDK (0.1.0b3), так
...
Codex. Новые SDK (>= 0.144.x) решили это сами — их enum'ы открытые через
`_missing_`; этот модуль в рантайме доустанавливает тот же механизм на
запиненный SDK, чтобы устойчивость жила в репо, а не в ручных правках
