...
Приоритет — Opus 5.5. Fable выбирается только в крайнем случае, когда нужен
экстра ум; явный выбор для конкретного вызова имеет приоритет.

| Когда | Модель | Параметры свежего вызова |
| --- | --- | --- |
| Крайний случай, когда нужен экстра ум | Fable 5.1 Medium | `profile: fable_advisor`, `effort: medium` |
