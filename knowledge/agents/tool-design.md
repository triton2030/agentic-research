...
- Для большого tool surface использовать narrow descriptions и tool search / deferred discovery, а не грузить весь каталог в основной контекст. Model-specific детали — `knowledge/wisdom-gpt-5.6.md`, `knowledge/wisdom-claude-opus-5.md`, `knowledge/wisdom-claude-fable-5.md`.
