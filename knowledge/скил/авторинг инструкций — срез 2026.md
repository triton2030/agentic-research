...
владеет [`knowledge/скил/как писать.md`](<как писать.md>); продвижение любого вывода в
...
[`knowledge/скил/имя метода вместо процедуры — срез 2026-08.md`](<имя метода вместо процедуры — срез 2026-08.md>).
...
- Wording и instruction density:
  [`knowledge/скил/формулировка и соблюдение — срез 2026-08.md`](<формулировка и соблюдение — срез 2026-08.md>).
