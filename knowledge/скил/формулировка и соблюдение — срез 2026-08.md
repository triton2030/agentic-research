...
- The Compliance Gap получил 0% process compliance при словесном согласии
  ...
  удаление affordance делегирования подняло compliance до 74.7%[^icr] без
...
[^icr]: Замер и его границы — `science/how-to-make-llm-obey.md`, раздел
    «Провенанс». Находка соло-препринта, независимо не реплицирована.
