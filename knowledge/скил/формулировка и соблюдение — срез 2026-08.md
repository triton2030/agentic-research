...
# Формулировка и соблюдение — срез 2026-08
...
- The Compliance Gap получил 0% process compliance при словесном согласии
  ...
  удаление affordance делегирования подняло compliance до 74.7% без
...
- Полная инженерия соблюдения:
  [`science/how-to-make-llm-obey.md`](../../science/how-to-make-llm-obey.md).
- Portable skill authoring truth: [`knowledge/скил/как писать.md`](<как писать.md>).
- System prompt guide:
  [`knowledge/инструкция/как писать/системный промпт.md`](<../инструкция/как писать/системный промпт.md>).
...
[^icr]: Число исправлено при проверке источника: ICR 74.7%, не 75%. Владелец
    замера и его границ — `science/how-to-make-llm-obey.md`, раздел
    «Провенанс исправлений».
