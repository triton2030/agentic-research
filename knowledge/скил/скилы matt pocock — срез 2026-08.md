...
# Скилы Matt Pocock — срез 2026-08
...
- Нет второго общего guide: portable truth остаётся в
  [`knowledge/скил/как писать.md`](<как писать.md>).
...
- [Authoring canon](<как писать.md>)
- [Research 2026 Mar-May](<что нашли снаружи — срез 2026.md>)
