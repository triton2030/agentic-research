...
# Почему скил не поднимается

Этот файл дополняет [`knowledge/скил/как писать.md`](<как писать.md>) только для одного
...
[`knowledge/скил/триггеры в середине траектории — срез 2026-08.md`](<триггеры в середине траектории — срез 2026-08.md>).
...
Один проход с фиксацией наблюдаемых фактов и несколько независимых
профессиональных линз — разные задачи. Скилы, закрывающие обе поверхности,
разводятся в `description` явно, иначе выбор между ними становится случайным
срабатыванием триггера.
