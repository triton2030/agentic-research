...
`knowledge/модель/свойства рабочего набора.md`, платформу — `knowledge/рантайм/claude code.md`.
...
- `knowledge/инструкция/как писать/системный промпт.md` — устойчивый system layer.
- `knowledge/инструкция/как писать/сборка контекста.md` — owner/evidence ordering и long-run context.
- `practical-guides/how-to-write-skills/` — concise dual-model Claude skill core.
- `knowledge/рантайм/claude code.md` — platform packaging и runtime semantics.
