...
Общие свойства LLM держит `knowledge/модель/свойства рабочего набора.md`; платформенные правила Claude Code
держит `knowledge/рантайм/claude code.md`; отличный от Opus маршрут сложнейших задач —
...
- `knowledge/инструкция/как писать/сборка контекста.md` — при сборке длинного контекста.
- `practical-guides/how-to-write-skills/` — при authoring Claude skills.
- `knowledge/рантайм/claude code.md` — когда Opus 5 работает внутри Claude Code.
