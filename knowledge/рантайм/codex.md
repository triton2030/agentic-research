...
- Процедура «рекомендуй и докажи: какую цель вывел и из чего, чем путь лучше,
  ...
  замену работающему способу, прямо названному пользователем, он при ней
  перестал.[^proof]
...
[^proof]: Те же пробы 2026-09-24, правило в `developer_instructions`. С
    процедурой доказательства путь лучше регулярки назван в 0 из 4 прогонов,
    с правилом «назови хотя бы одной строкой» — в 6 из 6, но без доказательства.
    Объяснение с выведенной целью и условием, при котором решение неверно, дано
    во всех 3 прогонах, где Codex вернул удалённый файл или чинил настоящую
    причину падения тестов. Лишних рекомендаций при простом переименовании —
    0 из 4.
