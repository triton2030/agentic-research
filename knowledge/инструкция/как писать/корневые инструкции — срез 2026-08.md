...
# Корневые инструкции — срез 2026-08
...
[`knowledge/инструкция/как писать/системный промпт.md`](<системный промпт.md>),
[`knowledge/инструкция/как писать/сборка контекста.md`](<сборка контекста.md>) и
[`knowledge/агент/слой исполнения.md`](<../../агент/слой исполнения.md>).
...
| GPT-5-mini | 96.4% | 84.5% | 20.1%[^mini] |
...
| [`knowledge/инструкция/как писать/системный промпт.md`](<системный промпт.md>) | Совместим: отделяет stable frame от task spec, удаляет повторы, obsolete process и runtime compensation |
| [`knowledge/инструкция/как писать/сборка контекста.md`](<сборка контекста.md>) | Совместим; изменений не потребовал, integrity-boundary остаётся в этом датированном evidence snapshot |
| [`knowledge/скил/как писать.md`](<../../скил/как писать.md>) | Совместим: no-skill comparator, progressive disclosure, interface-first tools и workflow только для order-sensitive failure |
| [`knowledge/скил/упаковка знания.md`](<../../скил/упаковка знания.md>) | Уточнён overbroad перенос постоянного индекса: resident delivery — крайний вариант, не enforcement |
...
- System prompts: [`knowledge/инструкция/как писать/системный промпт.md`](<системный промпт.md>).
- Context assembly: [`knowledge/инструкция/как писать/сборка контекста.md`](<сборка контекста.md>).
- Runtime enforcement: [`knowledge/агент/слой исполнения.md`](<../../агент/слой исполнения.md>).
- Instruction-carrier compliance:
  [`science/how-to-make-llm-obey.md`](../../../science/how-to-make-llm-obey.md).
- Skills:
  [`knowledge/скил/авторинг инструкций — срез 2026.md`](<../../скил/авторинг инструкций — срез 2026.md>).

[^mini]: Источник числа — Instruction Stacking Collapse, arXiv 2608.02639.
    Разбор кривой — `science/instruction-capacity-frontier-models-2026-09.md`,
    раздел про CSE. Независимой репликации у работы нет.
