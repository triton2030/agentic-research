---
description: "Датированный срез внешнего поля: эмбеддинги, графы зависимостей и retrieval для работы агента с кодом."
aliases: []
---

# Поиск по коду — срез 2026-Q2
...
Это датированный срез внешнего поля, а не действующее правило. Вывод отсюда
становится знанием об агенте только после повторного применения в нескольких
сессиях; тогда он формулируется в той стороне вещи, о которой верен, и срез
остаётся его опорой.
