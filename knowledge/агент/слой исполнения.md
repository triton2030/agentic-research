...
файл `knowledge/агент/набор инструментов.md`. Multi-agent runtime — `knowledge/агент/координация нескольких.md`. Memory —
`knowledge/агент/память.md`. Evaluation — `knowledge/агент/оценка.md`. Model-specific deltas —
...
- `knowledge/инструкция/как писать/системный промпт.md`
  Устойчивые правила по устройству стабильного instruction layer.

- `knowledge/агент/хуки.md`
