---
description: "Проверенные выводы про управление агентной системой: роли, память, оценка и аудит."
aliases: []
---
...
- Agent roles, role separation -> `knowledge/агент/координация нескольких.md`.
- Trajectory audit, observable acceptance criteria, multi-channel audit
  -> `knowledge/агент/оценка.md`.
- Полная retention vs structured forgetting -> `knowledge/агент/память.md`.
- User corrections как сильный memory signal -> `knowledge/агент/память.md`.
- Learnings quality gate -> `knowledge/агент/память.md`.
- Dedup / contradiction discipline -> `knowledge/агент/память.md`.
