...
loops. Runtime гарантии (где живёт критическое ограничение) — `knowledge/агент/слой исполнения.md`.
Evaluation memory effectiveness — `knowledge/агент/оценка.md`.
...
- `knowledge/инструкция/как писать/сборка контекста.md`
