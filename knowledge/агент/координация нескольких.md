...
- Параллельные линзы по одному материалу работают, пока они ортогональны: три
  роли с разным взглядом дают покрытие, которого один сквозной проход не даёт.
  Пять и больше уже пересекаются. Отбрасывание части выводов при синтезе — цена
  широты, а не признак плохого сигнала.
...
- `knowledge/рантайм/claude code.md`
