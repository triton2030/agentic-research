...
1. Name the current knowledge surface with [references/knowledge-map.md](knowledge-map.md).
2. Read only the thematic modules that match the real issue:
   - core model traits -> [references/model-behavior.md](model-behavior.md)
   - recurring degradation modes -> [references/failure-patterns.md](failure-patterns.md)
   - shortcutting and fake completion -> [references/escape-patterns.md](escape-patterns.md)
   - stronger control surfaces -> [references/control-levers.md](control-levers.md)
   - prompt writing -> [references/prompt-design.md](prompt-design.md)
   - agent construction -> [references/agent-design.md](agent-design.md)
   - skill construction -> [references/skill-design.md](skill-design.md)
...
7. Run the closing pass in [references/final-check.md](final-check.md).
...
- [references/knowledge-map.md](knowledge-map.md)
- [references/model-behavior.md](model-behavior.md)
- [references/failure-patterns.md](failure-patterns.md)
- [references/escape-patterns.md](escape-patterns.md)
- [references/control-levers.md](control-levers.md)
- [references/prompt-design.md](prompt-design.md)
- [references/agent-design.md](agent-design.md)
- [references/skill-design.md](skill-design.md)
- [references/final-check.md](final-check.md)
