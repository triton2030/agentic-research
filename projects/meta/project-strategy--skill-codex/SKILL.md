...
description: >
  Use for project direction and plan truth: goal, roadmap, plan, stage, trajectory, replan, куда дальше, зачем. Own `_ops/PROJECT-PLAN.md` and `_ops/learnings.md`. Route preferences to `preference-sync`, phase folders to `ops-sync`, task criteria to `task-contract`.
---
