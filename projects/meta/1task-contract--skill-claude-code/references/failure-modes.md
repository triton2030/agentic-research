...
Catalog of ways language models produce formal-pass-bad-work. Use during the adversarial pass of `1task-contract` (Step 3 of the task-file lifecycle). For each mode there is a probe question and a countermeasure criterion.
