...
name: task-contract
description: >
  Use for durable task scope: task files, acceptance criteria, Must/Must-not, verification, closeout, что считается готовым. Own `_ops/plans/phase-NN-*/task-MM-*.md`. Route plan/preference/architecture elsewhere. Skip lightweight preflight/review moments.
---
