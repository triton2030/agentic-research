...
Видимый выход ≤ 15 строк. Если `_ops/PROJECT-PLAN.md` нет — `forgotten — strategic map unavailable` и стоп. Не создавай отсутствующий файл — это территория `project-strategy`.
