...
description: >
  ...
  `task-contract`, durable user truth to `user-truth`, new unresolved branches
  to `strategy-discussion`, and strategy/status reconciliation to
  `project-roadmap`. Skip preflight and unrelated code review.
---
...
5. If the work revealed a new approach branch, hidden risk, or domain question
   that changes future strategy or scope, route to `strategy-discussion`.
...
7. If the result changes strategy/status truth, route reconciliation to `project-roadmap`.
