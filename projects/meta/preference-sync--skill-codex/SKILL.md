...
description: >
  Use for durable preference signals: хочу, не хочу, люблю, предпочитаю, важно, always, never, I prefer. Update `_ops/INTERVIEW.md` only, merging stale duplicates. Route conflicts to `contradiction-hold`. Skip one-off task facts and implementation details.
---
