...
#
# Вызывается main-strategy после каждой правки блока `## Stages`:
#   bash projects/meta/main-strategy--skill-claude-code/references/sync-ops.sh
#
# Контракт:
...
#   - task-файлы не трогает: их владелец — `task-planner`.
