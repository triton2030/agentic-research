...
инструментом будущих агентов: `1md-navigator`, `1md-graph`, текущие
execution owners через evidence-closeout и другие skills полагаются на него,
чтобы читать Markdown-граф, индексировать корпуса, проверять изменения и
