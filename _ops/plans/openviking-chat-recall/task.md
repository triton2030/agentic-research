...
| № | Веха | Готово, когда |
| --- | --- | --- |
| 1 | Пофайловое сухое знание | 196 файлов переписаны, имена один в один, модальность из ярлыка, выборочный смысловой аудит подтверждает верность — **шаг выполнен, аудит выборки остаётся** |
