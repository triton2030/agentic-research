...
`_ops/chat-recall/2026-08-22-140532-claude-efb50744.md`. Три слоя: разговоры
...
| 5 | Переносимость | протокол по `RUNBOOK.md` применён к чужой папке `_ops/chat-recall` **без правки своего текста** |
