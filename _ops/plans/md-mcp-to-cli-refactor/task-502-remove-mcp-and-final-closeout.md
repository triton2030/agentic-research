...
- [ ] **Archive task capsules**:
  - Каждый из 20 task-файлов → `_archive/YYYY-MM-DD-<task-slug>/` capsules
...
- [ ] Parity tests converted to snapshot-based, all green
- [ ] `md selftest` зелёный
...
- [ ] Все 20 task-файлов в `_archive/YYYY-MM-DD-<task-slug>/` capsules
...
7. `ls _ops/plans/md-mcp-to-cli-refactor/_archive/` → 20 dated capsules
