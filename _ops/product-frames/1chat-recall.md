...
5. `context-note` ожидается у изолированной цитаты, но содержит только surprise-
   дельту, которую нельзя вывести из цитаты вместе с `type/topic`; повтор хуже
   пустого поля.
...
Подтверждено владельцем 2026-08-04. Рабочие targets: GPT-5.6 и общий Claude
core для Opus 5/Fable 5; projections сохраняют один продуктовый и causal
contract.
