...
`нужен полный авторский черновик` — 2026-08-31, после трёх уточнений владельца
по смысловому черновику (`commander-intent.md` редакция 3): корпусный режим
снят, фиксированный каталог типов отменён в пользу методики выбора, вытеснение
не знает границы по авторству.
