...
владелец решил влить целиком и снять (`#L39`).
...
| E4, E7, I1–I4, I6–I8, D14, D15 | **выживут в свёрнутом виде** | Выбор дома по смыслу — заказан владельцем (`#L42`), но 20 механизмов лестниц и осей в бюджет не влезут |
| H5, H7, H9, H10, H12 | **кандидаты** | Признаки грязного, названные владельцем (`#L46`): чужой жанр, структурная грязь |
| C1, C5, C6, C14, C15, D1–D3, F1–F28, G1–G17 | **сняты почти целиком** | Evidence-контроллер read-only аудита с шестью гейтами и трассировкой операций. Новый скил — скил записи; владелец требует «без каких либо протоколов или длинных инструкций» (`#L49`) |
| C13 | **отменён владельцем** | «не создаёт system-wide homes или folder axes» — ровно то, что владелец заказал делать (`#L42`) |
