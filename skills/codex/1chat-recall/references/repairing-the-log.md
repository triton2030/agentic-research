...
Своя запись текущей сессии — не этот маршрут: её metadata исправляется по
разделу «Самоисправление метаданных текущей сессии» в Capture, а
repair-инварианты на неё не действуют.
