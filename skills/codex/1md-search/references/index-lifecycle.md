...
Confirm печатает ход работы в поток ошибок, а итоговый JSON — в конце.
Обрезанный или смешанный с потоком ошибок вывод теряет этот JSON, и исход
записи остаётся неизвестным: сохраняй вывод целиком в файл, при сомнении
исход покажет status.
