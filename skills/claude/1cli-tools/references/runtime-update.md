...
версией, даже если глобальный npm уже новее. Наблюдалось с Node 26.9.0 и
26.10.0: active npm сменился с 12.x на 11.19.1. Поэтому кандидата npm устанавливают
