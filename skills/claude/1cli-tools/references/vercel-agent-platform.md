---
description: "Agent, skills, sandbox and observability routes in Vercel CLI 60.0.1."
---

# Vercel CLI 60: Agent Platform

Момент: до ручного API/helper-а выбирается Vercel agent/platform route. Сверено
2026-09-25 с active Vercel CLI 60.0.1; beta/preview families меняются быстро.
