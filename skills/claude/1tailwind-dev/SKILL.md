...
name: 1tailwind-dev
description: >
  Keeps frontend design and implementation work on existing owners and familiar
  Tailwind/framework-native vocabulary before component, theme, or style source
  is created or edited. Use for every task that will design or change frontend
  UI code; skipping it creates parallel tokens, components, or styles. Do not
  use for critique that will not shape code.
---
