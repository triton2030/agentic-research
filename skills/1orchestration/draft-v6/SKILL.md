...
Оркестрация проектирует для root целую карту работы, а для каждого исполнителя —
выполнимый срез активных инструкций, критериев и знаний в точках решения.

## Цели

- До brief прочитаны все влияющие owner-источники.
- Каждый поток получил load-bounded brief.
- Root интегрировал принятые returns в один доказанный результат.
