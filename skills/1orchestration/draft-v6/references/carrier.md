...
Вход: general wave допущена без живого плана, а потеря root-контекста стоит
...
- После принятого возврата обнови status и переход в том же ходе.
- Меняющее ветку решение root запиши в `decisions.md` как
  `решение · основание · evidence`.
