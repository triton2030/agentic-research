...
по себе не доказывает сужение до этой папки. Проверяй фактический `path_scope`,
пути и исключения. Не меняй конфигурацию или scope молча ради удачной выдачи.
...
status с теми же
CLI-фильтрами, что у проверяемого поиска. Ниже пример без дополнительных
фильтров:
