...
`/Users/triton/Documents/GitHub/agentic-research/skills/1md-search/work/steering-2026-09-22/reports/ladder.md`.
...
Главная зона: цепочка от нужного пользователю следующего действия к поиску, чтению и индексации; сначала GOAL и product frame. Прочитай профиль /Users/triton/.codex/agents/ladder.toml и исполни его developer_instructions; верни родной результат.
