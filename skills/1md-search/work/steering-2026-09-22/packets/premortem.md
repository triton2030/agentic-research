...
`/Users/triton/Documents/GitHub/agentic-research/skills/1md-search/work/steering-2026-09-22/reports/premortem.md`.
...
Главная зона: последствия успешного глобального автоматического применения текущего skill. Метод и требуемый результат — /Users/triton/.codex/skills/1fresh-eyes/references/premortem.md. Не подменяй вред от успеха рассказом о неисполненной инструкции.
