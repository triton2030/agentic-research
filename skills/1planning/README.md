...
## Рефактор 2026-09-25 — роутеры

Тройка сведена обратно в один `1planning` по одобрению владельца: файл задачи —
роутер к местам документации, эпик — цель с основаниями, граница, порядок и
проверка целого. Тело написано через намерение, цель и пять критериев принятия.
Работа — [work/router-2026-09-25](work/router-2026-09-25/intent.md): намерение,
карта потерь, evidence чекера и пробы, исходы проверки Codex.
