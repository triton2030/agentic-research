...
`references/writing.md` 19, `agents/zone-reader.md` 8.
...
- **Остаточный риск.** Причинного замера по этим байтам нет: применение доктрины
  к пакету подтверждено только двумя волнами проверяющих. `writing.md` на 19
  единицах из 20 — следующая правка потребует объединения.
