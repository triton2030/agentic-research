# История 112-learning-mode

Живой владелец: [shared owner](../shared/112-learning-mode/portable/SKILL.md).
Продуктовая рамка: [product-frame](../shared/112-learning-mode/product-frame.md).
Прежняя история осталась в shared owner и не перемещается этим заказом.
