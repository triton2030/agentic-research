...
## 2026-09-08 — условные формулировки маршрутов

Статус: **установлено в Codex и Claude**.
SHA-256 SKILL.md: `3f9670cb6283faf34c2ea4f86cd1251b0b0269f4e856415d45d7f8748c64de28`.

Две независимые роли проверили инструкции и траекторию в двух волнах.
Две находки первой волны закрыты пояснениями причин и Markdown-маркерами;
новых действий или ограничений не добавлено. Получены условные записи на
четырёх синтетических случаях, включая неподтверждённого соседа и отсутствующий
INDEX. Это проверка формулировок и прогноза, не статистическое доказательство
надёжности и не исполнение на живом проектном индексе.

`sync_simple_projections.py 1index --check` подтвердил состав и байты owner,
двух tracked и двух installed проекций. `quick_validate.py` прошёл для кандидата
и обеих установок. Триггер и metadata сохранены. Карта потерь — `cut.md`,
основания, адрес ответа психолога и принятие замечаний —
