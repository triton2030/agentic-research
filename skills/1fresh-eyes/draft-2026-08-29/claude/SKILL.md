...
5. Если mode `named`, packet → terminal native product: прочитай [named](references/named.md); wrong premise исправь через [steering](references/steering.md), верни native product и останови Fresh Eyes pass.
6. Иначе panel packet → четыре terminal reports: прочитай [panel](references/panel.md).
7. Wrong premise в panel report → repaired report: прочитай [steering](references/steering.md) и замени исходный report.
8. Stable panel reports → decision handback: прочитай [synthesis](references/synthesis.md).
