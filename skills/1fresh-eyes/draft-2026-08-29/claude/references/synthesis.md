---
description: "Verify four panel reports and return one owner decision without voting."
---

# Synthesis

Вход: четыре terminal panel reports. Выход: next, alternative или unchanged.

Классифицируй сверху вниз; первый применимый label побеждает:

1. `invalid-test` — brief был leading/forked, спрашивал не того actor-а либо reports повторяют method, source и consequence.
...
Для каждой линзы сохрани native verdict, falsifier, source anchor и отдельное
