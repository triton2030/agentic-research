...
4. Для важной темы после основного поиска можно передать ровно одному фоновому
   субагенту независимый поиск по выбранному handle. Не жди его для продолжения
   исходной работы; при слиянии его находок снова прочти адресованные holders.
