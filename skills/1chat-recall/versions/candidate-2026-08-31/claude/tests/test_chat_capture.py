...
class ChatCaptureTests(unittest.TestCase):
    ...
    def test_capture_contract_gates_on_materiality(self) -> None:
        ...
        self.assertIn("находимым evidence", skill_text)
        self.assertIn("User-visible carrier\nне доказывает авторство", skill_text)
        ...
        self.assertIn("иначе верни gap", repair_text)
