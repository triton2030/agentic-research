...
similarity и metadata сами не доказывают owner authorship. Helper подтверждает
provenance сообщения, timestamp и source address, но не доказывает авторство
каждого фрагмента внутри вставленного текста.
