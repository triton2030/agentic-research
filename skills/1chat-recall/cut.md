...
- Старое решение выше — не выносить обычные Capture/Retrieval в references —
  остаётся видимым. Черновик проверяет, вытесняет ли его более новое общее
  правило о самостоятельных режимах; без наблюдаемой траектории чистого агента
  это не считается разрешённым конфликтом и не устанавливается в live.
