...
`versions/installed-2026-09-22-stable-records/` — постоянные адреса записей,
идентичность исходного ответа, блокировка записи и проверяемый перенос старых
ссылок. [Проверка и доставка](work/repair-2026-09-22/verification.md).
