...
| Opus/result gate усилен | `src/claude-policy.js:11-24`, `src/claude-result.js:33-35,75-113`; owner Opus-only: holder 2026-08-14 `:21`. | Fresh и session fail-closed без affirmative Opus evidence. | Bridge schema/model contract меняется либо probe принимает non-Opus как Opus result. |
