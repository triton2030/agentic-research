...
## 2026-09-12 — информационный скил и выполнение задач

По новому решению владельца сняты обязательная роль советника, read-only prompt
и stage-процедуры. Модельные предпочтения, prompting knowledge, функции и
...
## 2026-09-23 — приоритет Opus 5.5

Владелец [уточнил](../../_ops/chat-recall/2026-09-23-053301-codex-01a0cbab.md#recall-068a6cd4bc1447ea85a9726d2fa2d76f):
Opus 5.5 имеет приоритет; Fable нужен лишь в крайнем случае для экстра ума.
Таблица выбора и README моста исправлены. Возможность явного вызова Fable,
уровни effort и проверки точной версии модели сохранены.
Три независимые проверки выявили, что прежний порядок таблицы перекрывал
исключение Fable; узкое исключение поднято перед обычными маршрутами Opus.
