...
description: >
  ...
  `1chat-recall` через Skill tool по его собственному контракту, прибери за
  собой слой агентного управления и создай в `_ops/handoffs/` continuation
  packet с невосстановимой разговорной дельтой, точным следующим шагом,
  evidence-backed инцидентами и советом следующему агенту.
---
