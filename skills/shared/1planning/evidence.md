...
## 2026-08-26 — раскройка на тройку: пара обязательных субагентов

Одна пара на весь рефактор тройки (канон `1skill-refactor` шаг 5):

- **Сократитель**: тела всех трёх превышали ~20 единиц (27/28/29); главный
  диагноз — нормы в 2–4 экземплярах (тело ↔ форма ↔ red-list ↔ сосед).
  Принято его правило владения: «литеральная форма и red-list владеют
  нормой; тело держит момент, маршрут и то, чего в форме нет». Все названные
  дубли сняты, уникальные нормы сохранены; dashboard.md — пустой вердикт.
- **Проверщик ухудшений**: функции трёх скилов совпали с закреплёнными
  словами владельца (raw 2026-08-26-220614); трасса пробного случая «давай
  запланируем экспорт отчётов» прошла. Починены фейкуемые шаги («none do» →
  цитата строк, probe → письменный ответ в чате, `1use-principles` → имена
  принципов, «да» → на показанную декомпозицию), `эпик-снимок` получил
  нормализацию, bootstrap инструмента и деферал задачи получили
  производителей. Оставлено сознательно как цена строгости (решает
  владелец): агрессивный триггер без нижней границы, «спорь с владельцем»,
  frontier-сериализация, пол 3–7, молчание в native Plan Mode, связка с
  экосистемой 1*-скилов в portable.

Вердикты целиком — в транскриптах сессии 4ee6bbef (Claude, 2026-08-26).
