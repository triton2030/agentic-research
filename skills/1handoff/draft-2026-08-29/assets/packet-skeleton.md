...
- no recall address: <Гейт: стадия 1 назвала этот блокер. Предмет позиции,
  закрываемая развилка, последствие; иначе строку удали>
- cleanup: <названные изменения | nothing to clean | handed off>
- предыдущий полученный хендоф: <Гейт: сессия его унаследовала. Путь; иначе
  строку удали>
...
- оплаченная цена: <измеренное время; unknown, если не измерено — не удалять>
- почему нашлось поздно: <причина; unknown, если недоступна — не удалять>
