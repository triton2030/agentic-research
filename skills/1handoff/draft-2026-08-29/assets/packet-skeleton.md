...
<Где работа остановилась. У каждого claim-а два ярлыка.
`knowledge` — наблюдение либо `unverified`.
...
- no recall address: <Гейт: стадия 1 назвала этот блокер. Предмет позиции,
  закрываемая развилка, последствие>
- cleanup: <названные изменения | nothing to clean | handed off>
- предыдущий полученный хендоф: <Гейт: сессия его унаследовала. Путь>
