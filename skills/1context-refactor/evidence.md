...
## 2026-09-24 — ретроспектива сессии

[Намерение, карта потерь и проверка](work/retrospective-2026-09-24/decisions.md)
относятся к [зафиксированной редакции](versions/candidate-2026-09-24-retrospective/SKILL.md).
Три независимые роли не нашли материальных разрывов. Одна
[учебная проба](work/retrospective-2026-09-24/probe/result.md) дала разбор
лишних действий с сохранением необходимых проверок и неизвестных причин.
Сравнения поведения со старой версией и замера экономии не проводили.
Формат, metadata и совпадение всех четырёх проекций с owner проверены;
скил установлен в Codex и Claude.
