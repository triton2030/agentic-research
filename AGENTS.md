...
- **Первый уровень `knowledge/` раскладывается по предметам**, а не по стадии
  готовности документа. Исследование и эталон по предмету лежат внутри его
  папки, а не на отдельных полках `research/` и `examples/`. Решение владельца
  2026-09-10; образец формы — `practical-guides/how-to-write-skills/`.
