...
- [«почему скил не поднимается»](<knowledge/скил/почему скил не поднимается.md>)
  — почему скил не поднимается в середине траектории и как это чинит
  `description`.
- [«где расходятся платформы»](<knowledge/скил/где расходятся платформы.md>)
...
- [`science/how-to-make-llm-obey.md#четыре-механизма-отказа`](science/how-to-make-llm-obey.md)
  — обвал strict all-pass по числу одновременных правил (не memory cap),
  затухание по длине траектории, нечитаемый носитель, конкуренция формы вывода
  с мышлением.
